...
<div class="d-flex justify-content-center align-items-center min-vh-100 bg-light">
    <div class="card shadow-sm p-4" style="width: 100%; max-width: 450px; border-radius: 15px;">
        <h2 class="text-center mb-4 fw-bold text-primary">Registration</h2>
        ...
        <form>
            ...
            <button class="btn btn-primary w-100 btn-lg fw-bold">Register</button>
        </form>

        <div class="text-center mt-3">
            <small class="text-muted">Already have an account? <a href="{{ url('/login') }}" class="text-decoration-none">Login</a></small>
        </div>
    </div>
</div>
